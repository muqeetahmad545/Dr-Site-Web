  ...
  return (
    <div className="flex justify-center w-full relative">
      ...
      <div className="max-w-[1500px]  max-sm:max-w-[360px] max-lg:max-w-[640px] max-xl:max-w-[1023px] max-2xl:max-w-[1220px] max-sm:px-0 px-10">
        <p className="text-xl text-[#5aab53] mx-5 font-bold py-16 max-sm:text-2xl max-sm:pb-10">
          20+ Happy Patient
        </p>

        <div className="grid grid-cols-2 max-xl:grid-cols-1 gap-6 py-16 h-max pb-10 relative z-30 px-5">
          <div className="p-8 border-[5px] flex justify-between border-[#59ab51] rounded-xl h-full">
            <div>
              <h1 className="font-bold mb-4 text-2xl text-[#5aab53]">
                Premium Care
              </h1>
          ...
          <div
            ...
            className="p-8 border-3 flex border-[#59ab51] bg-secondary text-white rounded-xl h-full"
          >
