      ...
      <div className="innerContainer relative">
        <div>
          ...
          >
            ...
            >
              <span className="text-[#5bac52]"> HOW CAN WE </span> ADD VALUE
            </div>
          </div>
          <div className="grid grid-cols-3 max-sm:grid-cols-1 gap-12 mb-36 max-sm:mb-20">
            {data.map((item, index) => (
              ...
              >
                ...
                <p className="text-lg font-bold py-5 text-[#5aab53]">
                  {item.title}
                </p>
                <p
                  className="leading-7"
          ...
          <div className="w-full flex max-lg:flex-col justify-center gap-8 py-40 mb-40 relative max-lg:px-10">
            ...
            >
              ...
              <button className="p-2 px-6 max-sm:text-sm bg-[#5aab53] text-white rounded-xl">
                View More
              </button>
            </div>
            <div
