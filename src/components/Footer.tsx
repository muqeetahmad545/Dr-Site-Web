...
const Footer = () => {
    return (
        <div className='relative z-50'>
            <div  style={{background:COLORS.gradientPrimary}} className='text-white bg-gradientPrimary w-full flex justify-center px-50'>
                <div className='innerContainer relative p-8 z-50 px-10 flex max-lg:flex-col max-sm:flex-col justify-between'>
                    <div className='mb-10'>
                        <img src={Logo} alt='footerlogo' width={117} height={118} className='mb-6 max-sm:w-[80px] max-sm:h-[81px]' />
                        {/* <p>Questions? Reach us</p> */}
                        <p>We’ve positioned our beautiful offices near where you live, work, and travel.</p>
                        <p>{PHONE_NUMBER}</p>
                    </div>
                    <div className='flex max-sm:flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1 px-4 max-sm:px-0 max-sm:mb-4 min-w-48'>
                            ...
                            <div className='flex items-center gap-2'>
                                <img src='https://res.cloudinary.com/dfizbmrep/image/upload/v1710497201/call_g10xq1.png' alt='call' width={27} height={28} />
                                <span className='text-sm'>{PHONE_NUMBER}</span>
                            </div>
                            <div className='flex items-center gap-2'>
                                <img src='https://res.cloudinary.com/dfizbmrep/image/upload/v1710497227/sms_kcqqzq.png' alt='sms' width={27} height={28} />
                                <span className='text-sm'>{INFO_EMAIL}</span>
                            </div>
                        </div>
                        <div className='flex flex-col gap-1 px-4 max-sm:px-0 max-sm:mb-4 min-w-48'>
                            <h3 className='mb-5 font-bold'>Information</h3>
