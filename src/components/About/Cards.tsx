      ...
      <div className="innerContainer relative">
        <div>
          ...
          >
            ...
            <div className="text-5xl flex gap-2 font-extrabold justify-center">
              <span className="text-[#5bac52]"> HOW CAN WE</span>
              ADD VALUE
            </div>
          </div>
          <div className="grid grid-cols-3 max-sm:grid-cols-1 gap-12 mb-36 max-sm:mb-20">
            {data.map((item, index) => (
              ...
              >
                ...
                <p className="text-xl font-bold py-5 text-[#5aab53]">
                  {item.title}
                </p>
                <p
                  className="leading-7"
          ...
          <div className="w-full flex max-lg:flex-col justify-center gap-8 py-40 mb-40 relative max-lg:px-10">
            ...
            >
              <h2 className="text-center text-[#5aab53] font-bold text-2xl pt-6 max-sm:text-xl">
              ...
              <button className="p-2 px-6 max-sm:text-sm text-white rounded-xl bg-[#5aab53]">
                View More
              </button>
            </div>
            <div
            ...
            >
              <div
                ...
                className="p-10 px-16 rounded-xl text-white relative z-10 overflow-hidden max-sm:p-8"
              >
                <div className="z-30">
                  <h2 className="text-center font-bold text-2xl max-sm:text-xl pt-6">
